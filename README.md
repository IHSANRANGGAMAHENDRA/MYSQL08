...
![alt text](<gambar basis data/G.png>)
...
![alt text](<gambar basis data/G1.png>)
...
![alt text](<gambar basis data/G2.png>)
...
![alt text](<gambar basis data/G3.png>)
...
![alt text](<gambar basis data/G4.png>)
...
**Output :**
![alt text](<gambar basis data/G6.png>)
...
![alt text](<gambar basis data/G7.png>)
...
**Output :**
![alt text](<gambar basis data/G8.png>)
...
![alt text](<gambar basis data/G9.png>)
...
**Output :**
![alt text](<gambar basis data/G10.png>)
